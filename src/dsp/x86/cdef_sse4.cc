...
// Reversing with a shuffle is faster than the C implementation of bswap.
#if defined(LIBGAV1_HAS_X64) && !defined(LIBGAV1_SOFTWARE_BSWAP64)
  return _mm_cvtsi64_si128(BSwap64(_mm_cvtsi128_si64(v)));
#else
  const __m128i reverser = _mm_set_epi32(0, 0, 0x00010203, 0x04050607);
  return _mm_shuffle_epi8(v, reverser);
#endif  // defined(LIBGAV1_HAS_X64) && !defined(LIBGAV1_SOFTWARE_BSWAP64)
}
