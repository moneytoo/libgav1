...
typedef __m128i (*GetMasks)(const uint8_t* mask, const ptrdiff_t stride,
                            const __m128i zero);
typedef void (*InterIntraWriteMaskBlendLine10bpp)(
...
typedef void (*WriteMaskBlendLine10bpp)(
    const uint16_t* pred_0, const uint16_t* pred_1,
    const ptrdiff_t pred_stride_1, __m128i pred_mask_0, __m128i pred_mask_1,
    uint16_t* dst, const ptrdiff_t dst_stride, const __m128i offset,
    const __m128i zero, const __m128i max, const __m128i shift4);

static GetMasks GetMask[2][3];
static InterIntraWriteMaskBlendLine10bpp InterIntraWriteMaskBlendLine10bpp4x2;
static WriteMaskBlendLine10bpp WriteMaskBlendLine10bpp4x2;
...
void InitMask10bpp() {
  GetMask[0][0] = GetMask4x2_S;
  GetMask[0][1] = GetMask4x2_Sx;
  GetMask[0][2] = GetMask4x2_Sx_Sy;
  GetMask[1][0] = GetMask8_S;
  GetMask[1][1] = GetMask8_Sx;
  GetMask[1][2] = GetMask8_Sx_Sy;
  InterIntraWriteMaskBlendLine10bpp4x2 =
      InterIntraWriteMaskBlendLine10bpp4x2_SSE4_1;
  WriteMaskBlendLine10bpp4x2 = WriteMaskBlendLine10bpp4x2_SSE4_1;
}
...
inline void MaskBlending10bpp4x4_SSE4_1(
  ...
  __m128i pred_mask_1 = _mm_sub_epi16(mask_inverter, pred_mask_0);
  WriteMaskBlendLine10bpp4x2(pred_0, pred_1, pred_stride_1, pred_mask_0,
                             pred_mask_1, dst, dst_stride, offset, zero, max,
                             shift4);
  pred_0 += 4 << 1;
  pred_1 += pred_stride_1 << 1;
  mask += mask_stride << (1 + subsampling_y);
...
inline void InterIntraMaskBlending10bpp4x4_SSE4_1(
  ...
  __m128i pred_mask_0 =
      GetMask[0][subsampling_x + subsampling_y](mask, mask_stride, zero);
  __m128i pred_mask_1 = _mm_sub_epi16(mask_inverter, pred_mask_0);
  InterIntraWriteMaskBlendLine10bpp4x2(pred_0, pred_1, pred_stride_1,
